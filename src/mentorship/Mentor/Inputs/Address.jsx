...
function Address({next, back, handleAddressChange}) {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      <form onSubmit={next} className="flex flex-col items-center justify-center">
        ...
        <input id="address" type="text" className="text-lg border-2 border-slate-900 rounded-lg p-2 w-4/4 my-4" onChange={handleAddressChange} required placeholder='Tell us your address'/>
      <div className="flex">
