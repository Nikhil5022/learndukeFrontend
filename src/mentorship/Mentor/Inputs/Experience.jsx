...
function Experience({next, back, handleExperienceChange}) {
  return (
    <div className='flex flex-col items-center justify-center'>
      <form onSubmit={next} className="flex flex-col items-center justify-center">
        ...
        <input id="hfee" type="number" className="text-lg border-2 border-slate-900 rounded-lg p-2 w-4/4 my-4" onChange={handleExperienceChange} required placeholder='Tell us your exp.'/>
      <div className="flex">
